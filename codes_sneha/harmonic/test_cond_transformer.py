...
Also computes Pearson correlation, R², and SNR.
"""
...
def test_model(data_root,
    ...
    # Save per-channel CSVs & multi-channel grid
    if len(all_recons) == 0:
        print("No reconstructions collected (empty dataset?). Exiting.")
        return
