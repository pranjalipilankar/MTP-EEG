...
Results are saved to:
  /home/ab_students/EEG-MTP/codes_sneha/new_SEED4_hfd/
"""
import os
import sys
import argparse
...
# ---------------------------------------------------------------------------
DEFAULT_OUTPUT_DIR = "/home/ab_students/EEG-MTP/codes_sneha/new_SEED4_hfd"
...
def train_stad_model(stad_model, train_loader, val_loader, args, device, output_dir):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for batch in tqdm(train_loader, desc=f"Epoch {epoch + 1}/{args.epochs} [train]"):
            ...
            train_mse.append(mse_loss.item()); train_hfd.append(hfd_loss